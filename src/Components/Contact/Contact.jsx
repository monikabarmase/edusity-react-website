    ...
    <div className='contact'>
      <div className="contact-col"> 
        ...
        <p>Feel free to reach out through contact from or find our contact
          ...
          <ul>
            <li><img src={mail_icon} alt="" />indiaweb18@gmail.com</li>
            <li><img src={phone_icon} alt="" />+91 7846497761</li>
            <li><img src={location_icon} alt="" />Tushar Garder Phase 1 Pune <br /> 411002 Pune City</li>
          </ul>
          ...
          <div className="contact-col">
            <form onSubmit={onSubmit}>
               ...
               <button type='submit' className='btn dark-btn'>Submit 
                Now <img src={white_arrow} alt="" /></button>
            </form>
            <span>{result}</span>
          </div>
    </div>
